                    ...
                    children: [
                      ...
                      DropdownButton(
                        underline: Container(
                            ...
                            height: 2),
                        items: [
                          for (int i = 0; i < Sources.list.length; i++)
                            DropdownMenuItem(
                                child: Text(
                                  Sources.list[i].runtimeType.toString(),
                                ),
                                value: i),
                        ],
                        value: server,
                  ...
                  showCupertinoModalPopup(
                    ...
                    builder: (BuildContext context) {
                      return CupertinoAlertDialog(
                        ...
                        content: Text(
                            "This will reset all saved timestamps, including pinned shows and episode timestamps!"),
                        actions: [
