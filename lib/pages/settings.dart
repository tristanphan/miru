                ...
                child: Row(
                  ...
                  children: [
                    ...
                    ToggleSwitch(
                      ...
                      activeBgColor: [isDark ? Colors.white : Colors.black],
                      inactiveBgColor: isDark ? Colors.white10 : Colors.black12,
                      activeFgColor: isDark ? Colors.black : Colors.white,
                      changeOnTap: true,
                      initialLabelIndex: [
                        ThemeMode.system,
                        ThemeMode.light,
          ...
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                CupertinoButton(
                  child: Text(dismissText, style: TextStyle(color: Colors.red)),
                  onPressed: () {
