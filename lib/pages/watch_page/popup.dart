            ...
            children: [
              Material(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Seek.seek(widget.controller, SeekDirection.BACKWARDS, 10,
                        setState);
                    widget.setTimer();
                  },
                  onLongPress: () {
                    Seek.seek(widget.controller, SeekDirection.BACKWARDS, 83,
                        setState);
                    widget.setTimer();
                  },
                ),
              ...
              Material(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Seek.seek(widget.controller, SeekDirection.FORWARDS, 10,
                        setState);
                    widget.setTimer();
                  },
                  onLongPress: () {
                    Seek.seek(widget.controller, SeekDirection.FORWARDS, 83,
                        setState);
                    widget.setTimer();
                  },
                ),
            ...
            children: [
              Row(
                children: [
                  ...
                  Container(
                    width:
                        widget.controller.value.duration.inHours > 0 ? 90 : 60,
                    child: Center(
                      child: Text(
                ...
                SizedBox(
                  ...
                  child: Container(
                    ...
                    child: FlutterSlider(
                      ...
                      onDragCompleted: (handlerIndex, firstValue, secondValue) {
                        widget.setTimer();
                      },
                      ...
                      rtl: true,
                      values: [
                        max(min(widget.controller.value.volume, 1), 0) * 100,
                      ],
                    ),
                  ),
                ),
