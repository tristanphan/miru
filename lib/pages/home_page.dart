                                ...
                                await Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (BuildContext context) {
                                      return DetailsPage(
                                          title:
                                              data.recentReleases[index].title,
                                          url: data.recentReleases[index].url);
                                    },
                                  ),
                                );
                                setState(() {});
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    ClipRRect(
                                      child: Image.network(
                                        data.recentReleases[index].image,
                                        height: 220,
                                        width: 220 * 2 / 3,
                                        fit: BoxFit.cover,
                                        alignment: Alignment.center,
                                    ...
                                    Text(data.recentReleases[index].latestEp)
                                  ],
                                ),
                              ),
                            ),
                              ...
                              onTap: () async {
                                await Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (BuildContext context) {
                                      return DetailsPage(
                                          title: data.popular[index].title,
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(data.popular[index].latestEp),
                                    Padding(
                                      padding: EdgeInsets.all(2),
                                    ),
                                    Text(
                                      data.popular[index].genres,
                                      maxLines: 1,
                                      overflow: TextOverflow.ellipsis,
                                    )
                                  ],
